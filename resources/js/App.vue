        ...
        <div class="container mb-5">
            <div class="d-flex align-items-center py-4 header">
                ...
                <div class="ms-auto">
                    <a
                        :href="$meta.dashboard"
                        class="btn btn-primary d-inline-flex align-items-center mx-2"
                    >
                        <svg
            ...
            <div class="row mt-4">
                ...
                <div class="col-10">
                    <div
                        v-if="$meta.isDownForMaintenance"
                        class="alert alert-warning"
                    >
                        This application is in "maintenance mode". Queued jobs
                        may not be processed unless your worker is using the
                        "force" flag.
                    </div>
